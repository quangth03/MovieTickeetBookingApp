...
import { Text, View, StyleSheet, ScrollView, ImageBackground, TouchableOpacity, FlatList, ToastAndroid } from 'react-native';
...
function SeatBookingScreen({ navigation, route }): React.JSX.Element {
