...
import { Text, View, StyleSheet, ScrollView, ActivityIndicator, ImageBackground, Image, FlatList, TouchableOpacity, } from 'react-native';
                ...
                <ImageBackground
                    ...
                    <LinearGradient
                        ...
                        <View style={styles.appHeaderContainer}>
                            <AppHeader
                                name="close"
                                // header="quangsdfsdfsdfsdfadfsdffsdsdsdsdf"
                                exitFunction={() => navigation.goBack()}
                            />
                        </View>
                    </LinearGradient>
